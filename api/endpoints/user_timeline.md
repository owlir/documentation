...
title: /statuses/user_timeline
layout: default
parent: Endpoints
---
# /statuses/user_timeline/{uid}
- `uid`: User's `screen_name` or `id`
Get the user timeline. Authentication may be required, if the user is protected.
...
**Example:** `/v1/statuses/user_timeline/{uid}.xml?full=true`
