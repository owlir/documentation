...
title: /statuses/friends_timeline
layout: default
parent: Endpoints
---
# /statuses/friends_timeline/{uid}
- `uid`: User's `screen_name` or `id`
Get the with friends timeline from user. Authentication may be required, if the user is protected.
...
**Example:** `/v1/statuses/friends_timeline/{uid}.xml?full=true`
